...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph, config=config) as sess:
        ...
        while True:
            ...
            num_1 = cv2.putText(img, 'non-masked citizen:' + str(num1), (10, 25), font, 0.7, (237, 155, 255), 2)
            num_2 = cv2.putText(img, 'non-masked nonlocal:' + str(num2), (10, 50), font, 0.7, (0, 255, 252), 2)
            num_3 = cv2.putText(img, 'non-masked risky:' + str(num2), (10, 75), font, 0.7, (0, 0, 255), 2)
            cv2.imshow("AI defeater", img)
